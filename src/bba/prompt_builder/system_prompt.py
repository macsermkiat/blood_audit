...
_PLATELET_REVIEW_PROMPT: Final[str] = (
    ...
    "immunosuppression for aplastic anemia (ATG, cyclosporine) is NOT "
    "chemotherapy. In an excluded population APPROPRIATE requires the "
    ...
    "qualifying procedure, and no indication 4–7 below its threshold (or an "
