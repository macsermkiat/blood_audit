...
_PLATELET_REVIEW_PROMPT: Final[str] = (
    ...
    "chemotherapy. In an excluded population only the condition stated on its "
    "own line (for example active or life-threatening bleeding), or a "
    "procedure indication 1–3, grounded in the notes, supports "
    "APPROPRIATE.\n\n"
